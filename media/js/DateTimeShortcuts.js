...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        for (var i=0; i<scripts.length; i++) {
            if (scripts[i].src.match(/DateTimeShortcuts/)) {
                ...
                DateTimeShortcuts.media_prefix = scripts[i].src.substring(0, idx);
                break;
            }
        }
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', DateTimeShortcuts.media_prefix + 'img/icon_clock.gif', 'alt', 'Clock');
    ...
    addCalendar: function(inp) {
        ...
        quickElement('img', cal_link, '', 'src', DateTimeShortcuts.media_prefix + 'img/icon_calendar.gif', 'alt', 'Calendar');
        shortcuts_span.appendChild(document.createTextNode('\240'));
